									...
									<div className="sm:col-span-2">
											...
											<div className="text-lg leading-6 font-medium space-y-1">
												...
												<div className="flex space-x-4">
													<a
														...
														target="_blank"
														rel="noreferrer"
														className="flex w-1/2 justify-center bg-gray-200 space-x-2 rounded-lg shadow-sm p-2 text-center hover:outline outline-indigo-700 text-slate-600 hover:text-indigo-600 fill-slate-600 hover:fill-indigo-600 hover:bg-gray-300 hover:shadow-md transition-all duration-200"
													>
										...
										<div className="flex text-gray-600 mt-4 h-8">
											...
											{project.techUsed.map((tech) => (
												<svg className="w-6 fill-gray-500 mx-1">
													{tech.logo}
												</svg>
											))}
										</div>
